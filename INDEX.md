...
- `principles/001-seven-shadows-system.md`: Commander-led Seven Shadows governance for purposeful aesthetics, right-sized scale, and value-aligned UI delivery.
- `principles/002-reference-before-invention.md`: inspect the active product and suitable working references before choosing to keep, adapt, build, or reject a component.
