...
All agents must satisfy and follow every Shadow doctrine and discipline as a pre-task gate before accepting any task, and maintain compliance throughout execution under Court command authority.
