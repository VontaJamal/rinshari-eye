...
- Added lesson evidence card `ingestion/lessons/2026-02-18-seven-shadows-system.md` to document claims, evidence, a11y implications, and promotion trail.
...
- Upgraded the canonical `CORE-DOCTRINE` to Five Shadows plus a mandatory engineering baseline: TypeScript-by-default, strict typing discipline, controlled `any`, Zod boundary validation, and Python exception policy with Pydantic.
...
- Added `./agent-orchestration-lab` to baseline sync targets.
